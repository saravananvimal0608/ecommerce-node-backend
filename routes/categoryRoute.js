...
import { addCategory, allCategoryCount, deleteCategory, getAllCategory, updateCategory } from '../controllers/categoryController.js'
import upload from '../middleware/upload.js'
import adminMiddleware from '../middleware/adminMiddleware.js'

const router = express.Router()

router.get('/allCategoryCount',allCategoryCount)
